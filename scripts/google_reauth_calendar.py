#!/usr/bin/env python3
"""
One-time OAuth re-auth to add Google Calendar scope for OpenClaw automation.
Updates .secrets/google_sheets & drive.env with refreshed tokens.
"""
...
def main():
    ...
    print('✅ Calendar re-auth complete.')
    print('Granted scopes: sheets, drive, calendar.readonly')
    print('Updated token(s) in .secrets/google_sheets & drive.env')
