#!/usr/bin/env python3
"""
Test the correct way to trash a file in Google Drive API - Version 2 Fixed.
"""
...
print("🧪 TESTING TRASH METHODS - VERSION 2 FIXED")
print("=" * 40)
...
try:
    ...
    trashed_status = result.get('trashed', 'NOT IN RESPONSE')
    print(f"      ✅ Success! trashed status: {trashed_status}")
